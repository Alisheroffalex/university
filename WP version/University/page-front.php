<!DOCTYPE html>
<html data-page="home" data-layout="public" data-font-size="<? echo $_COOKIE['data-font-size'] ?>" data-letter-spacing="<? echo $_COOKIE['data-letter-spacing']; ?>" data-remove-colors="<? echo $_COOKIE['data-remove-colors']; ?>" >
  <head>
    <meta charset="UTF-8">
          ...
          <div class="row sp-between"> 
            <div class="university-text"> 
              <div class="header-block">
                ...
                <p class="text w-normal"><? echo get_theme_mod('university-section-text'); ?></p><img class="mobile-university-img responsive" src="<? echo get_template_directory_uri().'/images/'; ?>university.png"/><a class="btn" href="<?php echo get_permalink(get_theme_mod('university-section-link')); ?>"><?php echo __('Подробнее', 'univer'); ?></a>
              </div>
        ...
        <div class="f-gird"> 
          ...
          <div class="faculty-box">
            <div class="faculty-text"> 
              <h2 class="medium-header"><? echo $item['post_title']; ?></h2><a class="btn btn-gray" href="<? echo $item['link']; ?>"> <span class="desktop"><? _e('Подробнее', 'univer') ?></span><span class="responsive"> <i class="fas fa-angle-double-right"></i></span></a>
            </div><img class="faculty-overlay" src="<? echo $item['img']; ?>"/>
          </div>
          <?
            endforeach;
          ?>
        ...
        <div class="row sp-between">
          <?
            while ($the_query->have_posts()) : $the_query->the_post(); 
              $idNot = get_the_ID();
              ?>
                <div class="card bigCard"><img class="card-img" src="<? echo get_the_post_thumbnail_url(); ?>"/>
                  <div class="card-container"><a href="<? the_permalink(); ?>"><i class="fas fa-angle-double-right badge"></i></a>
              ...
              <div class='card-list'>
                ...
                ?>
                  ...
                  <div class="card-type-2">   <img class="card-type-img" src="<? echo get_the_post_thumbnail_url(); ?>"/>
